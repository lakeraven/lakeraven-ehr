...
Lakeraven::EHR::Engine.routes.draw do
  ...
  # PHI audit integrity screen (#488, split from #507). Gated on a
  # site-configured reviewer security key; with none configured it refuses
  # everyone.
  get "audit-review/integrity" => "audit_integrity#show", as: :audit_review_integrity
