...
Lakeraven::EHR::Engine.routes.draw do
  ...
  # PHI access audit review — the compliance officer's surface (#488).
  # Gated on a site-configured reviewer security key; with none configured it
  # refuses everyone.
  get "audit-review/integrity" => "audit_reviews#integrity", as: :audit_review_integrity
