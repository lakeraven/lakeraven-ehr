...
1. **Open http://localhost:3000/patients/1** — a clinician-readable chart for Anderson, Alice
...
3. **Add `.json` to the URL** → http://localhost:3000/patients/1.json — a FHIR R4 Bundle.
